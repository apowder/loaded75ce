...
// }}
    ...
    {
      $link .= $separator . '('.tep_session_name().')';
    } elseif (isset($_sid) && ($session_started)) {
  ...
  function tep_draw_input_field($name, $value = '', $parameters = '', $type = 'text', $reinsert_value = true) {
    ...
    if ( ($reinsert_value == true) && ( (isset($HTTP_GET_VARS[$name]) && is_string($HTTP_GET_VARS[$name])) || (isset($HTTP_POST_VARS[$name]) && is_string($HTTP_POST_VARS[$name])) ) ) {
      if (isset($HTTP_GET_VARS[$name]) && is_string($HTTP_GET_VARS[$name])) {
        $field .= ' value="' . \common\helpers\Output::output_string_protected(stripslashes($HTTP_GET_VARS[$name])) . '"';
      } elseif (isset($HTTP_POST_VARS[$name]) && is_string($HTTP_POST_VARS[$name])) {
        $field .= ' value="' . \common\helpers\Output::output_string_protected(stripslashes($HTTP_POST_VARS[$name])) . '"';
      }
