...
class Inventory extends ProviderAbstract implements ImportInterface, ExportInterface
{
    ...
    protected function initFields()
    {
        ...
        if (false && defined('USE_MARKET_PRICES') && USE_MARKET_PRICES == 'True') {
            ...
            $this->fields[] = array(
                ...
                'prefix'=>'i',
                'column_db' => 'inventory_discount_price',
    ...
    function set_products_full_price($field_data, $products_id)
    {
        if( $this->data[$field_data['name']]==='' ) {
            $this->data[$field_data['name']] = '-2';
        }elseif( floatval($this->data[$field_data['name']])==-2 || $this->data[$field_data['name']]=='same' ) {
    ...
    function set_products_discount_full_price($field_data, $products_id)
    {
