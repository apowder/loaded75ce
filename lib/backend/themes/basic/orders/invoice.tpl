          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            {foreach $order->products as $product}
              <tr class="dataTableRow">
                ...
                <td class="dataTableContentBorder dataTableContent_border" align="right" valign="middle">{$currencies->format($product.final_price, true, $order->info['currency'], $order->info['currency_value'])}</td>
                <td class="dataTableContentBorder dataTableContent_border" align="right" valign="middle">{$currencies->format($product.final_price * $product.qty, true, $order->info['currency'], $order->info['currency_value'])}</td>
                <td class="dataTableContent dataTableContent_border" align="right" valign="middle"><b>{$currencies->format(\common\helpers\Tax::add_tax($product.final_price, $product.tax) * $product.qty, true, $order->info['currency'], $order->info['currency_value'])}</b></td>
              </tr>
            {/foreach}
          </table>
