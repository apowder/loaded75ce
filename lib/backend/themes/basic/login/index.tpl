...
<body class="login">
	<div class="header after">
			<div class="phone">
				<span class="ico main_phone_namber">{$smarty.const.HEADER_PHONE}</span>
			</div>
<ul class="header_right">
			<li><a href="http://www.loadedcommerce.com/services/overview/">Ecommerce Development</a></li>
			<li><a href="http://www.loadedcommerce.com/support/support-overview/">Support</a></li>
			<li><a href="http://www.loadedcommerce.com/home/company/contact-us/">Contact Us</a></li>
		</ul>
	</div>
	<!-- Logo -->
	<div class="logo">
		<img src="{$app->view->theme->baseUrl}/img/loaded7-logo.png" alt="logo" width="279" height="63" style="max-width: 100%; max-height: none"/>
	</div>
	<!-- /Logo -->
