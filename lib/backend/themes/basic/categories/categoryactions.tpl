...
<div class="btn-toolbar btn-toolbar-order">
    ...
    <button class="btn btn-no-margin btn-move" onclick="confirmMoveCategory({$cInfo->categories_id})">{IMAGE_MOVE}</button><button class="btn btn-delete" onclick="confirmDeleteCategory({$cInfo->categories_id})">{IMAGE_DELETE}</button>
</div>
