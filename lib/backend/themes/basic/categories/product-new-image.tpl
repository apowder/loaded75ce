                    ...
                    <div class="tab-content tab-content-vertical">
                        <div class="tab-pane active one-img-gal" id="tab_4_{$Key}_0">
                            ...
                            <div class="one-img-gal-right">
                                ...
                                <div class="our-pr-line">
                                    <label><input type="checkbox" name="alt_file_name_flag[{$Key}][0]" value="1" {if $Item['alt_file_name'] != ""} checked{/if} class="uniform type-altr-file-name-{$Key}" /> {$smarty.const.TEXT_TYPE_ALTR_FILE}</label>
                        ...
                        <div class="tab-pane one-img-gal" id="tab_4_{$Key}_{$DItem['key']}">
                            ...
                            <div class="one-img-gal-right">
                                ...
                                <div class="our-pr-line">
                                    <label><input type="checkbox" name="alt_file_name_flag[{$Key}][{$DItem['id']}]" value="1" {if $DItem['alt_file_name'] != ""} checked{/if} class="uniform type-altr-file-name-{$Key}" /> {$smarty.const.TEXT_TYPE_ALTR_FILE}</label>
...
$('.type-altr-file-name-{$Key}').click(function(){ 
    $(this).parent('label').parent('div.our-pr-line').children('.type-altr-file-name-input').toggle();
});
