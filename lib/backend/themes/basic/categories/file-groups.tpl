                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="gallery_{$type_id}">
                        ...
                        <div class="setting-image"><img
                                  src="{$app->request->baseUrl}/../images/{$types[$language.id][$type_id].document_types_icon}"
                                  alt=""
                                  class="show-image"
  ...
  $('.btn-add-doc-type').off('click').on('click', function(){
    $.get('{$app->request->baseUrl}/categories/file-groups-add', function(d){
      $.each(d, function(i, item){
        var tab = $('.doc-gopes-box .tab-pane[data-language="'+item.language_id+'"]');
        tab.prepend(item.content);

        $('.btn-upload:last', tab).galleryImage('{$app->request->baseUrl}');
        $('.upload:last', tab).uploads();
