...
<head>
	...
	<link href="{$app->view->theme->baseUrl}/css/loaded7.css?1" rel="stylesheet" type="text/css" />
	...
	<header class="header navbar navbar-fixed-top" role="banner">
		...
		<div class="container">
			...
			<a class="navbar-brand" href="{$app->urlManager->createUrl("index")}">
				<img src="{$app->view->theme->baseUrl}/img/logo-loaded7.png" width="249" height="21" alt="logo" />
			</a>
			<!-- /logo -->
			...
			<ul class="header_menu_right">
				<li><a href="http://www.loadedcommerce.com/home/company/contact-us/" target="_blank">{$smarty.const.TEXT_HEADER_CONTACT_US}</a></li>
				<li><a href="http://www.loadedcommerce.com/support/support-overview/" target="_blank">{$smarty.const.TEXT_SUPPORT}</a></li>
				<li><a href="http://www.loadedcommerce.com/services/overview/" target="_blank">{$smarty.const.TEXT_ECOMMERCE_DEVELOPMENT}</a></li>
...
{$monthNames = [$smarty.const.TEXT_JAN, $smarty.const.TEXT_FAB,	$smarty.const.TEXT_MAR,	$smarty.const.TEXT_APR,	$smarty.const.TEXT_MAY,	$smarty.const.TEXT_JUN,	$smarty.const.TEXT_JUL,	$smarty.const.TEXT_AUG,	$smarty.const.TEXT_SEP,	$smarty.const.TEXT_OCT,	$smarty.const.TEXT_NOV,	$smarty.const.TEXT_DEC]}
		<div id="content">
                    <div class="container">
                        ...
                        <div class="footer">
                            <ul>
                                <li>Copyright &copy; 2005 - {$smarty.now|date_format:"%Y"} <a target="_blank" href="http://loadedcommerce.com">Global Ecommerce Solutions Ltd.</a></li>
                            </ul>
                        </div>
                    </div>
			<!-- /.container -->
