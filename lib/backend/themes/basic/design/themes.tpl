  ...
  {foreach $themes as $item}
    <div class="item">
      <div class="img">
        ...
        <div><img src="{DIR_WS_CATALOG}images/screenshot-{$item.theme_name}.png" alt=""></div>
      </div>
      ...
      <div class="buttons">
        ...
        <a href="{Yii::$app->urlManager->createUrl(['design/elements', 'theme_name' => $item.theme_name])}" class="btn btn-primary">{$smarty.const.TEXT_CUSTOMIZE}</a>
      </div>
      {*<div class="buttons">
