...
//        }}          
    ...
    public function actionSwitchStatus() {
        ...
        if ($lng['languages_id'] == $id) {
            ...
            if ((int) $_SESSION['languages_id'] == (int) $id && $status != 'true') {
