  ...
  public function actionIndex() {
    ...
    public function actionList() {
        ...
        $orders_status_query_raw =
          ...
          " left join " . TABLE_PRODUCTS_STOCK_DELIVERY_TERMS_TEXT . " dtt ON dtt.stock_delivery_terms_id=dt.stock_delivery_terms_id AND dtt.language_id='".(int)$languages_id . "' " . $search . " ".
          "order by {$orderBy}";
    ...
    public function actionListActions() {
      ...
      echo '<div class="or_box_head">' . (isset($oInfo->text[$_SESSION['languages_id']])?$oInfo->text[$_SESSION['languages_id']]['stock_delivery_terms_text']:'&nbsp;') . '</div>';
   ...
   public function actionSortOrder()
   {
     ...
     if ( $moved_id && in_array($moved_id, $ref_array) ) {
       ...
       $order_list_r = tep_db_query(
         ...
         "FROM ". TABLE_PRODUCTS_STOCK_DELIVERY_TERMS ." dt ".
         " LEFT JOIN " . TABLE_PRODUCTS_STOCK_DELIVERY_TERMS_TEXT . " dtt ON dtt.stock_delivery_terms_id=dt.stock_delivery_terms_id AND dtt.language_id='".(int)$_SESSION['languages_id'] . "' " .
         "WHERE 1 ".
         "ORDER BY dt.sort_order, dtt.stock_indication_text"
       );
