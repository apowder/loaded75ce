...
class SocialsController extends Sceleton {
    ...
    public function actionList() {
        ...
        while ($social = tep_db_fetch_array($socialsQuery)) {
            $responseList[] = array(
                ...
                ($social['module'] != 'instagram' ? '<input name="active" type="checkbox" class="check_on_off" ' . ($social['active'] ? " checked" : "") . '>' : ''),
            );
        }
    ...
    public function actionEdit() {
        ...
        $_social->hasAuth = ($_social->module == 'instagram' ? false : true);
        $messages = Yii::$app->session->getAllFlashes();
        Yii::$app->session->removeAllFlashes();
    ...
    public function actionChange() {
        ...
        if ($platform_id && $socials_id) {
            ...
            if ($_status['test_success']) {
                ...
                $message .= ' ' . \common\models\Socials::getSiteUrl($_status['module']);
            }
        }
    ...
    public function actionTest() {
        ...
        \common\models\Socials::loadComponents($platform_id, $module);
