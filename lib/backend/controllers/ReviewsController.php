...
class ReviewsController extends Sceleton {
    ...
    public function actionIndex() {
        ...
        $this->navigation[] = array('link' => Yii::$app->urlManager->createUrl('reviews/index'), 'title' => HEADING_TITLE);
    ...
    public function actionList() {
        ...
        if( isset( $_GET['search']['value'] ) && tep_not_null( $_GET['search']['value'] ) ) {
            ...
            $search_condition = " where r.reviews_id=rd.reviews_id /*and rd.languages_id = '$languages_id'*/ and r.products_id = p.products_id  and p.language_id = '$languages_id' and p.products_name like '%" . $keywords . "%' ";

        } else {
            $search_condition = " where r.reviews_id=rd.reviews_id /*and rd.languages_id = '$languages_id'*/ and r.products_id = p.products_id  and p.language_id = '$languages_id' ";
        }
        ...
        if (tep_not_null($output['from'])) {
            ...
            $filter .= " and to_days(r.date_added) >= to_days('" . $date->format('Y-m-d') . "')";
        }
        ...
        $reviews_query_raw = "
            select r.reviews_id, r.products_id, r.date_added, r.last_modified, r.reviews_rating, r.status, r.new, p.products_name, rd.reviews_text
...
//            tep_draw_hidden_field( 'item_id', $item_id ) ;
    ...
    public function actionConfirmitemdelete()
    {
        ...
        $contents[] = array( 'text' => TEXT_INFO_DELETE_REVIEW_INTRO . '<br>' );
