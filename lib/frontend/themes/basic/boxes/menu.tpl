<div class="menu {$settings[0].class}" style="display: none">
    ...
    {if $settings[0].class == 'menu-big'}
      ...
      var menu_trigger = function(){
        $('.menu-big > ul > li > ul > li > ul', menu).each(function(){
          ...
          if ($('> li', this).length > 2){
            $(this).append('<li class="show-all">{$smarty.const.TEXT_SHOW_ALL}</li>');
          }
        });
        $('.menu-big li.show-all', menu).on('click', function(){
          if ($(this).hasClass('show-all-hide')){
            $(this).removeClass('show-all-hide');
            $(this).html('{$smarty.const.TEXT_SHOW_ALL}');
            $(this).parent().find('.hide-more').removeClass('hide-more-disable')
          } else {
            $(this).addClass('show-all-hide');
            $(this).html('{$smarty.const.TEXT_HIDE}');
