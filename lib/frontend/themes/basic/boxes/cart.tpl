<div id="cart-box" class="cart-box{if $settings[0].show_products == 'dropdown'} hover-box{/if}">
  <a href="{tep_href_link('shopping-cart/index')}">
    <span class="no-text">
  ...
  <div class="cart-content">
    ...
    <div class="buttons">
      <div class="left-buttons"><a href="{tep_href_link('shopping-cart/index')}" class="btn">{$smarty.const.TEXT_HEADING_SHOPPING_CART}</a></div>
      <div class="right-buttons"><a href="{tep_href_link('checkout/index')}" class="btn">{$smarty.const.HEADER_TITLE_CHECKOUT}</a></div>
    </div>
  </div>
  {/if}
