...
<div class="item">
  ...
  {if !$settings[0].show_name}
    <div class="title name"><a href="{$product.link}">{$product.products_name}</a></div>
  {/if}
  ...
  {/if}
    ...
    {if !$settings[0].show_description}
      <div class="description description-2">{if $product.products_description_short}{$product.products_description_short|truncate:90:"...":false}{else}{$product.products_description|truncate:90:"...":true}{/if}</div>
    {/if}
