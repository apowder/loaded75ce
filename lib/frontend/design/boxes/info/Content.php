...
class Content extends Widget
{
  ...
  public function run()
  {
    ...
    $sql = tep_db_query("select if(length(i1.description), i1.description, i.description) as description from " . TABLE_INFORMATION . " i LEFT JOIN " . TABLE_INFORMATION . " i1 on i.information_id = i1.information_id  and i1.languages_id = '" . (int)$languages_id . "' AND i1.platform_id='".\common\classes\platform::currentId()."' and i1.affiliate_id = '" . (int)$HTTP_SESSION_VARS['affiliate_ref'] . "'  where i.information_id = '" . (int)$info_id . "' and i.languages_id = '" . (int)$languages_id . "' and i.visible = 1 and i.affiliate_id = 0 AND i.platform_id='".\common\classes\platform::currentId()."' ");
